...
> <br>
> 👉 **[https://mrfeixiang.github.io/christmas-tree-iphone/](https://mrfeixiang.github.io/christmas-tree-iphone/)**
...
### How to Use
1.  **Access:** Open the [Live Demo](https://mrfeixiang.github.io/christmas-tree-iphone/) on your iPhone or Android.
...
### 操作指南
1.  **访问：** 在手机浏览器中打开 [在线链接](https://mrfeixiang.github.io/christmas-tree-iphone/)。
2.  **交互：** 点击屏幕任意空白处，粒子将在**“星河模式”**（散开）和**“圣诞树模式”**（聚合）之间平滑切换。
3.  **定制：** 点击底部的**相机图标 (📷)** 上传一张照片（如家人合影）。照片将自动生成在金色粒子环绕的中心位置。
...
### 프로젝트 개요
**Three.js**로 제작된 모바일 중심의 미니멀리스트 3D 웹 경험입니다. "블랙 & 골드"의 고급스러운 미학을 바탕으로 디자인되었으며, 사용자는 화면을 탭하는 것만으로 흩어진 입자 은하수를 나선형 크리스마스 트리로 변환할 수 있습니다. 사용자가 직접 사진을 업로드하여 3D 우주의 중심에 띄울 수 있는 디지털 연하장 역할을 합니다.

### 사용 방법
1.  **접속:** 스마트폰 브라우저에서 [라이브 데모 링크](https://mrfeixiang.github.io/christmas-tree-iphone/)를 엽니다.
